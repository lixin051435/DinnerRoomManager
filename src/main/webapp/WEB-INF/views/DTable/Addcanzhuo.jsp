...
<head>
    ...
    <script src="${APP_CONTEXT}/common/js/Addcanzhuo.js"></script>
</head>
<body>
...
<section style="position: relative;border: 0px solid red;width: 500px;margin: 20px auto;">
    <form id="frm" class="layui-form" action="">
        <input type="text" name="id" id="upid" value="${diningTable.id}" readonly="readonly" hidden="hidden">
        <div class="layui-form-item">
            <label class="layui-form-label">座位号：</label>
            <div class="layui-input-inline">
                <input type="text" value="${diningTable.tableNum}" name="tableNum" id="table_num" placeholder="请输入座位号"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="${diningTable.tablePernum}" name="tablePernum" id="table_Pernum"
                       placeholder="请输入餐桌可座人数" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
